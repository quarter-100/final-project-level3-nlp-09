...
def get_config():
    ...
    parser.add_argument('--test_path', type= str, default= '/opt/airflow/dags/data/inference_sample.csv',
                        help='train csv path (default: /opt/airflow/dags/data/inference_sample.csv')   
...
if __name__ == '__main__':
    ...
    #model= YesOrNoModel(args.model_name).to(device)
