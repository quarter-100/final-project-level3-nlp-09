...
with DAG(
    ...
    train_task = BashOperator(
        ...
        bash_command='python /tmp/airflowtmpsyixurw0/final-project-level3-nlp-09/train.py',
        owner="dain",
        dag=dag
    )
    """
    inference_task1 = BashOperator(
        ...
        bash_command='python /tmp/airflowtmpsyixurw0/final-project-level3-nlp-09/inference_best.py',
        owner="dain",
        dag=dag
    )
    ...
    inference_task2 = BashOperator(
        ...
        bash_command='python /tmp/airflowtmpsyixurw0/final-project-level3-nlp-09/inference_new.py',
        owner="dain",
        dag=dag
    )
    ...
    upload_retrained_model = BashOperator(
        ...
        bash_command='python /tmp/airflowtmpsyixurw0/final-project-level3-nlp-09/upload_model.py',
        owner="dain",
        dag=dag
    )
